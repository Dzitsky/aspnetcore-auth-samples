...
namespace Authorization.Tests
{
    class TestAuthenticationHandler : IAuthenticationHandler
    {
        ...
        public static void SetupSuccess(string scheme, params Claim[] claims) =>
            _authenticateResults[scheme] = AuthenticateResult.Success(new AuthenticationTicket(
                new ClaimsPrincipal(new ClaimsIdentity(claims, nameof(TestAuthenticationHandler))), scheme));
